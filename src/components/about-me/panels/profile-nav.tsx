...
import navLogo from "../../../assets/about-me/topright.gif";
        ...
        <nav className="relative m-[1em] text-[12px] text-white shadow-[5px_8px_10px_#0006]">
          ...
          >
            <img
              ...
              alt="Remyz13"
              fetchPriority="high"
              className="-mt-[15px] -mb-[14px] -ml-[10px] h-[71px] w-[178px] min-w-0 shrink object-contain object-left max-xs:h-[57px] max-xs:w-[142px] max-xxs:-mt-[8px] max-xxs:h-[40px] max-xxs:w-[100px]"
            />
